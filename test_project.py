...
def Api_Connection():
    ...
    api_version = "v3"
    apikey = "AIzaSyBl8fp2eq_aPnuz62rcBjfkJ2QwPYe_hc4"
...
connection = MongoClient("mongodb+srv://karthik:karthik@cluster0.ugjnviy.mongodb.net/")
...
def show_data(channel_dropdown):
    ...
    connection= mysql.connector.connect(host="localhost",user="root",password="@Karthik30",database="youtube_data1")
